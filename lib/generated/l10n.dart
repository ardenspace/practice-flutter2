...
class S {
  ...
  /// `Log in {gender, select, male{sir} female{ma'am} other{}}`
  String logIn(String gender) {
    return Intl.message(
      'Log in ${Intl.gender(gender, male: 'sir', female: 'ma\'am', other: '')}',
      name: 'logIn',
      desc: 'Log in text with gender',
      args: [gender],
    );
  }
}
